...
#define ctz(x) __builtin_ctzll(x) // 40 = 101000 → returns 3 (Trailing zeroes)
#define clz(x) __builtin_clzll(x) // 8 = 1000 → returns 60 (as it's 64-bit) (leading zeroes)
#define parity(x) __builtin_parityll(x) // 7 = 111 → 3 ones → returns 1 (Parity checks)
